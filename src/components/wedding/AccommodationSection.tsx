...
const AccommodationSection = () => {
  const hotels = [
    {
      name: 'Hotel Villa San Michele',
      description: 'Luxury 5-star hotel with stunning views of the Tuscan hills',
      distance: '5 min from venue',
      amenities: ['Free WiFi', 'Pool', 'Shuttle Service'],
      link: '#',
    },
    {
      name: 'Borgo Artimino',
      description: 'Charming boutique hotel on the villa grounds',
      distance: 'Walking distance',
      amenities: ['Free WiFi', 'Restaurant', 'Spa'],
      link: '#',
    },
    {
      name: 'Agriturismo Bacciolo',
      description: 'Authentic Tuscan farmhouse experience',
      distance: '10 min from venue',
      amenities: ['Free Parking', 'Breakfast Included', 'Wine Tasting'],
      link: '#',
    },
  ];
      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-body text-muted-foreground max-w-2xl mx-auto">
            We've curated a selection of beautiful places to stay near our venue.
            Book early as September is a popular time in Tuscany.
          </p>
        </motion.div>
